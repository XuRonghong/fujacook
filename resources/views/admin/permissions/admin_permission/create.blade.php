                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="admin_id" value="{{data_get($data['arr'], 'admin_id')}}"
                                               class="form-control admin_id" id="com3" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="com4" class="col-sm-3 text-right control-label col-form-label">permission id<span style="color:red">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="permission_id" value="{{data_get($data['arr'], 'permission_id')}}"
                                               class="form-control permission_id" id="com4" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
