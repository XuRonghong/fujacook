...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen"
          href="/web_assets/v3/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" media="screen"
          href="/web_assets/v3/css/font-awesome.min.css">

    <!-- SmartAdmin Styles : Caution! DO NOT change the order -->
    <link rel="stylesheet" type="text/css" media="screen"
          href="/web_assets/v3/css/smartadmin-production-plugins.min.css">
    <link rel="stylesheet" type="text/css" media="screen"
          href="/web_assets/v3/css/smartadmin-production.min.css">
    <link rel="stylesheet" type="text/css" media="screen"
          href="/web_assets/v3/css/smartadmin-skins.min.css">

    <!-- SmartAdmin RTL Support -->
    <link rel="stylesheet" type="text/css" media="screen"
          href="/web_assets/v3/css/smartadmin-rtl.min.css">
    ...
    <link rel="apple-touch-icon" sizes="120x120"
          href="/web_assets/v3/img/splash/touch-icon-iphone-retina.png">
    <link rel="apple-touch-icon" sizes="152x152"
          href="/web_assets/v3/img/splash/touch-icon-ipad-retina.png">
    ...
    <link rel="apple-touch-startup-image" href="/web_assets/v3/img/splash/iphone.png"
...
<header id="header">
    <div id="logo-group">
        <span id="logo"> <img src="{{$vImage_logo or asset('portal_assets/dist/img/logo2.png')}}" alt="EzCenter" style="width: 170px;></span>
    </div>
    ...
    <div id="content" class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                ...
                <p class="note text-center">{{trans('web.login.footer')}}</p>
            </div>
        </div>
    </div>
</div>
