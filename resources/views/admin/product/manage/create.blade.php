                ...
                <div class="card" id="manage-modal">
                    ...
                    <form id="sample_form" class="form-horizontal">
                        <div class="card-body messageInfo-modal">
                            ...
                            <div class="form-group row">
                                <label for="com5" class="col-sm-1 text-right control-label col-form-label">num</label>
                                <div class="col-sm-11">
                                    <input type="text" name="num" value="{{data_get($data['arr'], 'num')}}" class="form-control num" id="com5" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="service_description" class="col-sm-1 text-right control-label col-form-label">service_description</label>
                                <div class="col-sm-11 note-editable">
