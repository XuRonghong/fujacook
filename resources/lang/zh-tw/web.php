...
return [
    'default_unit' => ' 個',
    'meta_keyword' => '鍋具品牌,鍋具料理,鍋具推薦,鍋具介紹,鍋具收納,鍋具配件,鍋具不沾鍋,鍋具專賣店,如何挑選鍋具,多功能鍋具,鍋子品牌,鍋子料理,鍋子推薦,鍋子介紹,鍋子收納,鍋子配件,鍋子不沾鍋,鍋子專賣店,如何挑選鍋子多功能鍋子,即食鍋具,即食鍋子,即食鍋,即時餐,各國料理,各式料理,fujacook,FUJACOOK即食鍋,富呷一方',
    'meta_description' => '即時的歡樂趴，永恆的幸福感。 富呷一方, fujacook, 即食鍋, FUJACOOK即食鍋',
    'user_type' => [
        'administrator' => '系統管理員',
        'manager' => '管理員',
        'director' => '經理',
