...
<?php
            ...
            if (!isset($_POST['wallet_eth'])&&!isset($_POST['kahap_status'])) {
?>
    <form id="form1" action="http://fine-i.com/kahap/am_eth_wallet_post.php" method="post">
...
<?php
              ...
              $txhash="";
              if (isset($_POST['wallet_eth']))
                $wallet=$_POST['wallet_eth'];
?>
              <div class="panel panel-danger">
                ...
                <div class="panel-body">
                  <br>          
                  <div>
                    <span class="input-group-addon blue">交易wallet: <?php echo $wallet; ?></span>
                  </div><br>
                  <div>
