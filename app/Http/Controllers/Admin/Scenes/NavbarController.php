...
class NavbarController extends Controller
{
    ...
    public function __construct(ScenesRepository $repository, ScenesPresenter $presenter)
    {
        ...
        $this->presenter->setTitle(trans('menu.scenes.navbar.title'));
    ...
    public function list(Request $request)
    {
        ...
        if(request()->ajax())
        {
            $data = $this->repository->getDataTable($request, "type LIKE 'navbar%'");
    ...
    public function create()
    {
        ...
        $data['arr']['options'] = $this->presenter->getSelectOption('navbar');
    ...
    public function show($id)
    {
        ...
        //轉換出顯示數據
        $data['arr'] = $this->presenter->transOne($data['arr'], 'navbar');
