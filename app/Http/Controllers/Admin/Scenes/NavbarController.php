...
class NavbarController extends Controller
{
    ...
    public function __construct(ScenesRepository $repository, ScenesPresenter $presenter)
    {
        ...
        $this->presenter->setViewName('scenes.navbar');
        $this->presenter->setTitle('Scenes navbar');

        //所有關於route::resource的位置
        $this->route_url = $this->presenter->getRouteResource($this->presenter->setRouteName('admin.scenes.navbar'));
    }
    ...
    public function list(Request $request)
    {
        ...
        if(request()->ajax())
        {
            $data = $this->repository->getDataTable($request, 'type = "navbar.home"');
    ...
    public function create()
    {
        ...
        $data['arr']['options'] = $this->presenter->getSelectOption_navbar();
        //to ajax url
        $data['route_url'] = $this->route_url;
    ...
    public function show($id)
    {
        ...
        //get option for select
        $data['arr']['options'] = $this->presenter->getSelectOption_navbar($data['arr']['type']);
